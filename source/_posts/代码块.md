...
文字{
    ...
    /**background-clip属性指定背景绘制区域。border-box	默认值。背景绘制在边框方框内（剪切成边框方框）。padding-box	背景绘制在衬距方框内（剪切成衬距方框）。content-box	背景绘制在内容方框内（剪切成内容方框）。**/
    -webkit-background-clip:text;
    /**文字中填充颜色 transparent:透明色**/
...
/**动画**/
@keyframes float {
  /**0% 是动画的开始时间，100% 动画的结束时间。或者通过关键词 "from" 和 "to"，等价于 0% 和 100%。**/ 	
  100% {
